...
haha.test = function() {
    var $ = cheerio.load('<div class="clearfix mt-15">' +
    '<p class="text word-wrap">前天去理发店剪头发～～～ 我：哥们儿帮我剪一个能找到女朋友的发型！ 发型师对着屋里大喊了一声：老板，有人来砸场子了</p> ' +
    '<div class="clear"></div> </div>', {decodeEntities: false});
    var pstr = $("p").html();
    //=>
}
module.exports = haha;
